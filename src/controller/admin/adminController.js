...
const { sendOTP } = require("../../utils/sendEmails/sendEmailForCode");
const {
  generateTokenForForgetPassword,
} = require("../../utils/generateToken/generateTokenForForgetPass");
...
exports.forgetPassword = async (req, res) => {
  try {
    ...
    const payload = {
      id: isAdminExist?._id,
      tokenVersion: isAdminExist?.tokenVersion,
    };

    const resetToken = generateTokenForForgetPassword(payload);
    ...
    await sendOTP("rohitsingh78794@gmail.com", "123456");
